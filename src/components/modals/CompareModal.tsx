...
export const CompareModal: React.FC<CompareModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="flex flex-col w-full max-w-6xl h-[90vh] bg-canvas border border-default rounded-xl shadow-2xl overflow-hidden pointer-events-auto"
        ...
        <div className="flex items-center justify-between px-5 py-3 border-b border-default bg-surface shrink-0">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-sm font-semibold text-primary flex items-center gap-2">
                Compare Code
                <span className="text-[10px] font-mono font-normal px-2 py-0.5 rounded bg-surface-elevated text-secondary border border-default">
                  Phase 3C
                </span>
              </h2>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-surface-elevated hover:bg-surface-hover active:bg-surface text-primary border border-default rounded text-xs font-medium transition-colors cursor-pointer"
        ...
        <div className="flex-1 overflow-y-auto min-h-0 p-5 space-y-4">
          ...
          {!snapshotA ? (
            <div className="flex flex-col items-center justify-center h-full py-16 text-center space-y-4">
              <div className="p-4 bg-surface border border-default rounded-full text-amber-400">
                <Camera className="w-8 h-8" />
              </div>
              <div className="max-w-md space-y-1">
                <h3 className="text-base font-semibold text-primary">No Version A Snapshot Saved</h3>
              ...
              <button
                onClick={onTakeSnapshot}
                className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded text-xs font-semibold shadow-sm transition-colors cursor-pointer"
              >
            ...
            <>
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 bg-surface border border-default rounded-lg p-3">
                {/* Version A Info */}
                <div className="flex items-center gap-2 text-xs font-mono">
                  ...
                  <span className="text-secondary font-medium">{snapshotA.label}</span>
                  <span className="text-muted text-[11px]">
                    ({new Date(snapshotA.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', second: '2-digit' })})
                  </span>
                </div>

                <ArrowLeftRight className="w-4 h-4 text-muted hidden sm:block" />
                ...
                <div className="flex items-center gap-2 text-xs font-mono">
                  ...
                  <span className="text-secondary font-medium">{snapshotB.label}</span>
                  <span className="text-muted text-[11px]">
              ...
              <div className="bg-surface border border-default rounded-lg overflow-hidden flex flex-col h-[280px]">
                <div className="flex items-center justify-between px-3 py-1.5 border-b border-default bg-canvas text-[11px] font-mono text-secondary">
                  <span className="flex items-center gap-1.5">
                    <FileCode2 className="w-3.5 h-3.5 text-secondary" />
                    Source Code Diff (Version A ↔ Version B)
                  </span>
                  <span className="text-muted uppercase">{snapshotB.language}</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-surface border border-default rounded-lg p-4 space-y-3">
                    <div className="flex items-center justify-between border-b border-subtle pb-2">
                      ...
                      <span className="text-[10px] text-muted font-mono">Deterministic Engine</span>
                    </div>

                    <div className="space-y-2 text-xs">
                      {/* Time Complexity Row */}
                      <div className="bg-canvas border border-subtle rounded p-2.5 space-y-1">
                        <div className="text-[11px] text-secondary font-medium">Time Complexity</div>
                        <div className="flex items-center justify-between font-mono">
                          <span className="text-secondary">
                            Version A: <strong className="text-primary">{comparisonResult.complexity.versionATime}</strong>
                            {comparisonResult.complexity.versionAConfidence && (
                              <span className="text-[10px] text-muted ml-1">({comparisonResult.complexity.versionAConfidence})</span>
                            )}
                          </span>
                          <span className="text-muted">→</span>
                          <span className="text-secondary">
                            Version B: <strong className="text-primary">{comparisonResult.complexity.versionBTime}</strong>
                            {comparisonResult.complexity.versionBConfidence && (
                              <span className="text-[10px] text-muted ml-1">({comparisonResult.complexity.versionBConfidence})</span>
                            )}
                          </span>
                        </div>
                      ...
                      <div className="bg-canvas border border-subtle rounded p-2.5 space-y-1">
                        <div className="text-[11px] text-secondary font-medium">Auxiliary Space Complexity</div>
                        <div className="flex items-center justify-between font-mono">
                          <span className="text-secondary">
                            Version A: <strong className="text-primary">{comparisonResult.complexity.versionASpace}</strong>
                          </span>
                          <span className="text-muted">→</span>
                          <span className="text-secondary">
                            Version B: <strong className="text-primary">{comparisonResult.complexity.versionBSpace}</strong>
                          </span>
                        </div>
                  ...
                  <div className="bg-surface border border-default rounded-lg p-4 space-y-3">
                    ...
                    {comparisonResult.benchmark.isComparable ? (
                      <div className="space-y-2 text-xs">
                        <div className="grid grid-cols-2 gap-2 bg-canvas border border-subtle rounded p-2.5 font-mono">
                          <div>
                            <div className="text-[10px] text-muted uppercase">Version A Average</div>
                          ...
                          <div>
                            <div className="text-[10px] text-muted uppercase">Version B Average</div>
                        ...
                        <div className="bg-canvas border border-subtle rounded p-2.5">
                      ...
                      <div className="bg-canvas border border-subtle rounded p-3 text-xs space-y-1.5">
                  ...
                  <div className="bg-surface border border-default rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs font-mono">
                      <div className="bg-canvas border border-subtle rounded p-2.5 space-y-1">
                        <div className="text-[10px] text-muted uppercase">Version A Patterns</div>
                        {comparisonResult.dsaPatternsA.length > 0 ? (
                          ...
                          <p className="text-muted text-[11px]">Standard structural logic</p>
                        )}
                      </div>

                      <div className="bg-canvas border border-subtle rounded p-2.5 space-y-1">
                        <div className="text-[10px] text-muted uppercase">Version B Patterns</div>
                  ...
                  <div className="bg-surface border border-default rounded-lg p-4 space-y-3">
                    ...
                    <div className="space-y-2 text-xs font-mono">
                      {/* Test cases evidence */}
                      <div className="bg-canvas border border-subtle rounded p-2.5 flex items-center justify-between">
                        <span className="text-secondary text-[11px]">Test Cases Passed:</span>
                      ...
                      <div className="bg-canvas border border-subtle rounded p-2.5 flex items-center justify-between">
                        <span className="text-secondary text-[11px]">Execution Status:</span>
                        <div className="flex items-center gap-2">
                          <span className="text-secondary">
              ...
              {comparisonResult && comparisonResult.summaryItems.length > 0 && (
                <div className="bg-surface border border-default rounded-lg p-4 space-y-2.5">
                  <h3 className="text-xs font-semibold text-primary uppercase tracking-wide flex items-center gap-1.5 border-b border-subtle pb-2">
                  ...
                  <div className="space-y-1.5">
                    {comparisonResult.summaryItems.map((item, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2.5 py-1.5 px-3 rounded bg-canvas border border-subtle text-xs font-mono"
                      >
                        ...
                        <span className="text-secondary font-semibold shrink-0">{item.label}:</span>
